#!/usr/bin/env python3
"""
model-evaluation-suite - data_loader.py
Script to load model and datasets for evaluation.
...
def main():
    parser = argparse.ArgumentParser(
        description="Script to load model and datasets for evaluation."
    )
    ...
    print(f"🚀 model-evaluation-suite - data_loader.py")
