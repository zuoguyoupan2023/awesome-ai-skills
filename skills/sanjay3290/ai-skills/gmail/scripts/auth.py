...
KEYCHAIN_SERVICE = "gmail-skill-oauth"
KEYCHAIN_ACCOUNT = "main-account"

# Gmail API requires this scope
SCOPES = [
...
def save_stored_tokens(token_info: TokenInfo) -> bool:
...
def main():
    ...
    parser = argparse.ArgumentParser(description="Gmail OAuth management")
    ...
    if args.command == "login":
        ...
        if token_info:
            ...
            print("Tokens stored in system keyring.")
        else:
            print("Login failed.")
            sys.exit(1)
